...
public class Cart {
    ...
    public Cart(int quantity1, int quantity2, int quantity3, int quantity4, int quantity5, int quantity6, int quantity7,
    		int quantity8, int quantity9, int quantity10) {
        ...
        this.quantity2 = quantity7;
        this.quantity3 = quantity8;
        this.quantity4 = quantity9;
        this.quantity5 = quantity10;
