...
public class CartDaoImpl{
    ...
    public void saveToCart(NewCart[] newCarts){
        ...
        if(newCarts.length>6)
            cart.setQuantity7(newCarts[6].getQuantity());
        if(newCarts.length>7)
            cart.setQuantity8(newCarts[7].getQuantity());
        if(newCarts.length>8)
            cart.setQuantity9(newCarts[8].getQuantity());
    ...
    public void updateDB(){
        ...
        if(foods.size()>6)
            foods.get(6).setQuantity(foods.get(6).getQuantity()-cart.getQuantity7());
        if(foods.size()>7)
            foods.get(7).setQuantity(foods.get(7).getQuantity()-cart.getQuantity8());
        if(foods.size()>8)
            foods.get(8).setQuantity(foods.get(8).getQuantity()-cart.getQuantity9());
        if(foods.size()>9)
            foods.get(9).setQuantity(foods.get(9).getQuantity()-cart.getQuantity10());
